...
<div class="colab-modal-backdrop" data-modal-backdrop>
  <div class="colab-modal" role="dialog" aria-modal="true" aria-label="Historial del área o departamento">
    <header>
      <div>
        <div class="ev-title">Historial — {{ $area->nombre }}</div>
        <div class="ev-meta">ID #{{ $area->id }}</div>
      </div>
    ...
    <div class="content">
      @if($historial->isEmpty())
        <p class="ev-meta">Sin historial registrado para esta área o departamento.</p>
      @else
        <ul class="timeline">
