...
<div class="colab-modal-backdrop" data-modal-backdrop>
  <div class="colab-modal" role="dialog" aria-modal="true" aria-label="Historial del puesto">
    <header>
      <div>
        <div class="ev-title">Historial — {{ $puesto->nombre }}</div>
        <div class="ev-meta">ID #{{ $puesto->id }}</div>
      </div>
    ...
    <div class="content">
      @if($historial->isEmpty())
        <p class="ev-meta">Sin historial registrado para este puesto.</p>
      @else
        <ul class="timeline">
