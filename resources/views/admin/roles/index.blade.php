...
<style>
  ...
  #roles-toolbar .select-wrap{position:relative;display:inline-block}
  #roles-toolbar select[name="per_page"]{
  ...
  #roles-toolbar .select-wrap .caret{
...
(function(){
  ...
  const perPageSelect = document.querySelector('#roles-toolbar select[name="per_page"]');
  const tbody = document.getElementById('roles-tbody');
  const pager = document.getElementById('roles-pagination');
  let t, ctl;

  function buildUrl(pageUrl = null){
    const base = pageUrl || "{{ route('admin.roles.index') }}";
